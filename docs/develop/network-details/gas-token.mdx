...
- **Step 2: Deposit MATIC Token:**
    - You can deposit token using our wallet web,
        ...
        - You can use Maticjs: [https://docs.polygon.technology/docs/develop/maticjs/getting-started](https://docs.polygon.technology/docs/develop/maticjs/getting-started)
